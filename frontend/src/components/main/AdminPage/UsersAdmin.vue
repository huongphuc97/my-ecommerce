...
export default {
  ...
  methods: {
    createUser() {
      axios.post(
        "https://api-ecm.herokuapp.com/categories/accounts/create",
        {
    ...
    deleteUser(accounts) {
      axios.delete(`https://api-ecm.herokuapp.com/categories/accounts/${accounts.id}`, {
        params: {
          role: this.role,
        },
      });
    ...
    editModalData() {
      axios.put(
        `https://api-ecm.herokuapp.com/categories/accounts/${this.modalData.id}`,
        {
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
          .get("https://api-ecm.herokuapp.com/categories/accounts/admin", {
            params: {
              role: this.role,
            },
          })
