...
export default {
  ...
  methods: {
    createUser() {
      axios.post(
        "https://api-for-ecm-app.herokuapp.com/accounts/create",
        {
    ...
    deleteUser(accounts) {
      axios.delete(`https://api-for-ecm-app.herokuapp.com/accounts/${accounts.id}`, {
        params: {
          role: this.role,
        },
      });
    ...
    editModalData() {
      axios.put(
        `https://api-for-ecm-app.herokuapp.com/accounts/${this.modalData.id}`,
        {
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
          .get("https://api-for-ecm-app.herokuapp.com/accounts/admin", {
            params: {
              role: this.role,
            },
          })
