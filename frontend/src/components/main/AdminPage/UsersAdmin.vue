...
export default {
  ...
  methods: {
    createUser() {
      axios.post(
        "https://my-api-for-frontend.herokuapp.com/accounts/create",
        {
    ...
    deleteUser(accounts) {
      axios.delete(`https://my-api-for-frontend.herokuapp.com/accounts/${accounts.id}`, {
        params: {
          role: this.role,
        },
      });
    ...
    editModalData() {
      axios.put(
        `https://my-api-for-frontend.com/accounts/${this.modalData.id}`,
        {
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
          .get("https://my-api-for-frontend.herokuapp.com/accounts/admin", {
            params: {
              role: this.role,
            },
          })
