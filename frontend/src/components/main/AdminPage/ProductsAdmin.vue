        ...
        <tbody>
          <tr v-for="pro in products" :key="pro.id">
            ...
            <td>
              <img
                class="card-img-top"
                :src="`https://api-for-ecm-app.herokuapp.com/public/image/products/${pro.image}`"
                alt=""
              />
            </td>
            <td>{{ pro.category }}</td>
...
export default {
  ...
  methods: {
    ...
    createProduct() {
      ...
      axios.post("https://api-for-ecm-app.herokuapp.com/products", fd, {
    ...
    deleteProduct(product) {
      axios.delete(`https://api-for-ecm-app.herokuapp.com/products/${product.id}`);
    ...
    editModalData() {
      ...
      axios.put(`https://api-for-ecm-app.herokuapp.com/products/${this.modalData.id}`, f, {
        params: { role: this.role },
      });
      this.refreshProductsApi();
    },
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        ...
        axios
          .get("https://api-for-ecm-app.herokuapp.com/products/admin", {
            params: {
              role: this.role,
            },
          })
