          ...
          <div v-if="this.products" class="row">
            ...
            >
              <div class="card text-left">
                <img
                  class="card-img-top"
                  :src="`http://localhost:3000/public/image/products/${total.image}`"
                  alt=""
                />
  ...
  methods: {
    ...
    async getData() {
      var response = await axios.get(
        `http://localhost:3000/products/pages=${this.currentPage}`
      );
    ...
    searchByPrice() {
      axios
        .get(`http://localhost:3000/products/range/${this.value}`)
    ...
    async cate() {
      ...
      if (this.searchCategories === "men") {
        ...
        var response = await axios.get(
          `http://localhost:3000/products/women/page/${this.currentPageWomen}`
        );
        var responseData = response.data;
    ...
    searchProduct() {
      ...
      axios
        .get(
          "http://localhost:3000/products/search/bykey/" + getInput.value + ""
        )
