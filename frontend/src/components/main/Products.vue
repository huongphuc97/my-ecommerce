          ...
          <div v-if="this.products" class="row">
            ...
            >
              <div class="card text-left">
                <img
                  class="card-img-top"
                  :src="`https://get-api-ecommerce-pj.herokuapp.com/public/image/products/${total.image}`"
                  alt=""
                />
  ...
  methods: {
    ...
    async getData() {
      var response = await axios.get(
        `https://get-api-ecommerce-pj.herokuapp.com/products/pages=${this.currentPage}`
      );
    ...
    searchByPrice() {
      axios
        .get(`https://get-api-ecommerce-pj.herokuapp.com/products/range/${this.value}`)
    ...
    async cate() {
      ...
      if (this.searchCategories === "men") {
        ...
        var response = await axios.get(
          `https://get-api-ecommerce-pj.herokuapp.com/products/women/page/${this.currentPageWomen}`
        );
        var responseData = response.data;
    ...
    searchProduct() {
      ...
      axios
        .get(
          "https://get-api-ecommerce-pj.herokuapp.com/products/search/bykey/" + getInput.value + ""
        )
